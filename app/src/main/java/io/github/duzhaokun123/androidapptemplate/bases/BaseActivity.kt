...
import io.github.duzhaokun123.screentransfer.R
import io.github.duzhaokun123.screentransfer.databinding.ActivityBaseRoot2Binding
import net.matsudamper.viewbindingutil.ViewBindingUtil

abstract class BaseActivity<BaseBinding : ViewBinding>(
    private val baseBindingClass: Class<BaseBinding>, vararg val configs: Config, @StyleRes val themeId: Int = R.style.Theme_ScreenTransfer
) : AppCompatActivity() {
    enum class Config {
        NO_TOOL_BAR,
        LAYOUT_NO_TOOL_BAR,
